// Ported verbatim from UNDEFINED-FrontEnd (src/shaders/IcoshadrenShader/*)
// - vertex: perlin-noise displacement driven by mouse speed
// - fragment: fake-UV landscape texture warped by 4D periodic perlin noise
// - fragmentLines: barycentric wireframe pass
// - postProcessing: rgb-shift + grain + noiseblur full-screen pass

export const icoVertex = `
    varying vec2 vUv;
    uniform float time;
    uniform float mouse;
...
export const icoFragment = `
    ...
    //	Classic Perlin 4D Noise, periodic version
    //	by Stefan Gustavson
    vec4 permute(vec4 x){return mod(((x*34.0)+1.0)*x, 289.0);}
    vec4 taylorInvSqrt(vec4 r){return 1.79284291400159 - 0.85373472095314 * r;}
...
export const icoFragmentLines = `
    ...
    void main(){
        ...
        gl_FragColor = vec4(mix(vec3(0.), vec3(0.), line), 1.); //dark
    }
`
...
export const PostProcessing = {
    ...
    fragmentShader: /* glsl */`
        ...
        void main(){
            ...
            vec3 color = vec3((t.rbg) / noiseblur);
